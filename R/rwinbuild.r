...
#' Uses \code{\link[devtools:check_win]{check_win_release}}, \code{\link[devtools:check_win]{check_win_devel}} or \code{\link[devtools:check_win]{check_win_oldrelease}} internally.
#'
#' @template path
